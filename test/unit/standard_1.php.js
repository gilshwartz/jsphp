/** 
 * standard_1.php - Unit Test (QUnit)
 */
...
test('strtoupper ($string) ', function(){
    ok(false, 'Not implemented yet.');
});

test('strtolower ($str) ', function(){
    ok(false, 'Not implemented yet.');
});
...
test('str_repeat ($input, $multiplier) ', function(){
    ok(false, 'Not implemented yet.');
});
